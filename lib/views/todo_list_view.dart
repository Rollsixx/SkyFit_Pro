...
class _TodoListViewState extends State<TodoListView> {
  ...
  List<TodoModel> _applyFilters(List<TodoModel> all) {
    ...
    list.sort((a, b) => switch (_sortOption) {
          ...
          SortOption.title    => a.title.toLowerCase().compareTo(b.title.toLowerCase()),
          SortOption.dueDate  => () {
        ...
        child: Column(
          ...
          children: [
            ...
            ...SortOption.values.map((opt) => ListTile(
                  ...
                  leading:  Icon(opt.icon, color: _sortOption == opt ? cs.primary : null),
                  ...
                  trailing: _sortOption == opt
                      ...
                      : null,
                  onTap: () { setState(() => _sortOption = opt); Navigator.pop(context); },
                )),
          ],
        ),
      ),
  ...
  void _openEditSheet(dynamic todo) => showModalBottomSheet(
        context: context, isScrollControlled: true,
        backgroundColor: Colors.transparent,
  ...
  Future<void> _deleteTodo(String id) async {
    final email = context.read<AuthViewModel>().currentUser?.email ?? '';
    await context.read<TodoViewModel>().deleteTodo(ownerEmail: email, todoId: id);
  }
            ...
            SliverToBoxAdapter(
              child: Column(
                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...
                        // Priority pills (skip "All" — clearing happens via "Clear")
                        ...PriorityFilter.values.skip(1).map((p) {
                          final sel = _priorityFilter == p;
                          final col = p.color(context);
                  ...
                  // Search / sort info row
                  if (_searchQuery.isNotEmpty || _sortOption != SortOption.newest)
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          if (_sortOption != SortOption.newest)
                            Row(children: [
                              Icon(_sortOption.icon, size: 12, color: cs.primary),
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate(
                        (_, i) {
                          ...
                          final over = todoVm.isOverdue(todo);
                          return TodoCard(
                            ...
                            isOverdue:     over,
                            index:         i,
                            onToggle: () => todoVm.toggleCompleted(
